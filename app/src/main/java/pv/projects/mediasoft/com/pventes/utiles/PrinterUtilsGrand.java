...
import pv.projects.mediasoft.com.pventes.Main2Activity;
...
public class PrinterUtilsGrand {
    ...
    public PrinterUtilsGrand(Context context){
    ...
    public void printTicket(long id,int duplicata){
        ...
        msg += "----------------------------------------------";
        msg += "\n";
        msg+= context.getString(R.string.enteteputilgrand);
        msg += "\n";
        msg += "----------------------------------------------";
        msg+= "\n";
        ...
        for (int i = 0; i < n; i++){
            ...
            String ligne = mv.getProduit() + " " + String.valueOf(mv.getQuantite()) + " " + Utiles.formatMtn(mv.getPrixV())   + " " + Utiles.formatMtn(mv.getPrixV()*mv.getQuantite())  ;
    ...
    private String alignRight(String ligne) {
        String result = "" ;
        for (int i = 0; i < 43 - ligne.length(); i++) {
            result += " " ;
        }
        result = result + ligne ;
        return result;
    ...
    private String alignRight1(String ligne) {
        String result = "" ;
        for (int i = 0; i < 42 - ligne.length(); i++) {
            result += " " ;
        }
        result = result + ligne ;
        return result ;
    ...
    public String totaux(String totaux){
        int n = 32 ;
        int siz = 0 ;
        totaux = (totaux.length()>31)?(totaux.substring(0,30)):(totaux) ;
        siz = n-totaux.length() ;
        for (int i =0 ; i < siz; ++i){
            totaux = " " + totaux ;
        }
    ...
    public String totaux1(String totaux){
        int n = 30 ;
        int siz = 0 ;
        totaux = (totaux.length()>28)?(totaux.substring(0,27)):(totaux) ;
        siz = n-totaux.length() ;
        for (int i =0 ; i < siz; ++i){
            totaux = " " + totaux ;
        }
