...
public class Main2Activity extends Activity {
    ...
    class ClickEvent implements View.OnClickListener {
        public void onClick(View v) {
            if (v == btnSearch) {
                Intent serverIntent = new Intent(Main2Activity.this,DeviceListActivity.class);      //ÔËÐÐÁíÍâÒ»¸öÀàµÄ»î¶¯
                ...
                if((lang.compareTo("en")) == 0){
                    ...
                    // + "  »¶Ó­ÄúµÇÂ¼ÎÒÃÇµÄÍøÕ¾À´²é¿´ÎÒÃÇ¹«Ë¾µÄÏêÏ¸ÐÅÏ¢:\n"+"     http://www.zjiang.com.\n\n";
                    mService.sendMessage(msg,"GBK");
                }
            }
        }
    ...
    private void printImage() {
        ...
        pg.initCanvas(384);
        pg.initPaint();
        String path = Environment.getExternalStorageDirectory().getAbsolutePath() + "/Mediasoft/logo.bmp";
