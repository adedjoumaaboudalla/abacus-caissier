...
public class ImmoFormActivity extends AppCompatActivity implements View.OnClickListener, View.OnLongClickListener {
    ...
    ImmoFormActivity.AddOperationTask addOperationTask = null ;
    ...
    private void initialisation() {
        ...
        to = typeOperationDAO.getAllImmo();
        ...
        mAdapter = new ArrayAdapter(ImmoFormActivity.this, android.R.layout.simple_list_item_1, typeoperations);
        ...
        venteBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                money_init() ;
                achat = false ;
                builder = new AlertDialog.Builder(ImmoFormActivity.this) ;
                builder.setView(rv) ;
                alert = builder.show() ;
            }
        });
        ...
        modegroupe.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, @IdRes int checkedId) {
                ...
                if (checkedId == R.id.espece) {
                    ...
                    CompteBanqueDAO compteBanqueDAO = new CompteBanqueDAO(ImmoFormActivity.this) ;
                    ...
                    mAdapter = new ArrayAdapter(ImmoFormActivity.this, android.R.layout.simple_list_item_1, banque);
    ...
    private void addOperation() {
        if (isValid()){
            ...
            addOperationTask = new ImmoFormActivity.AddOperationTask(description.getText().toString(),montant.getText().toString(),to.get(spinner.getSelectedItemPosition()-1),cpt_bk) ;
    ...
    private boolean isValid() {
        ...
        if (spinner_banque.getSelectedItemPosition()==0 && spinner_banque.getVisibility()==View.VISIBLE && cb.size()>0) {
            Toast.makeText(ImmoFormActivity.this, getString(R.string.baquerror), Toast.LENGTH_LONG).show();
            return false;
        }
        ...
        if (MODE.equals(CHEQUE) && numerocheque.length()==0){
            Toast.makeText(ImmoFormActivity.this, getString(R.string.saisirnumcheque), Toast.LENGTH_LONG).show();
            return false;
        }
    ...
    public class AddOperationTask extends AsyncTask<Void, Integer, String> {
        ...
        public AddOperationTask(String desc, String mte, TypeOperation typeOperation,long cpt) {
        ...
        protected void onPostExecute(String result) {
            ...
            if (Long.valueOf(result)>0) {
                clean();
                Toast.makeText(ImmoFormActivity.this,getString(R.string.immo_success),Toast.LENGTH_LONG).show();
            }
            else
                Toast.makeText(ImmoFormActivity.this,getString(R.string.echec_ajout),Toast.LENGTH_LONG).show();
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            if (operationDAO==null)operationDAO = new OperationDAO(ImmoFormActivity.this) ;
            if (caisseDAO==null)caisseDAO = new CaisseDAO(ImmoFormActivity.this) ;
            if (typeOperationDAO==null)typeOperationDAO = new TypeOperationDAO(ImmoFormActivity.this) ;
        }
    }
