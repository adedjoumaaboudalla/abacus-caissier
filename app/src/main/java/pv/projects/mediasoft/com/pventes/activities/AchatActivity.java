...
public class AchatActivity extends AppCompatActivity implements VenteplusFormFragment.OnFragmentInteractionListener, View.OnClickListener, View.OnLongClickListener {
    ...
    */
        ...
        if (id == R.id.action_liste) {
            Intent intent = new Intent(AchatActivity.this,OperationActivity.class) ;
