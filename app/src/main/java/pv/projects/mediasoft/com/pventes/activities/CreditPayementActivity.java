...
public class CreditPayementActivity extends AppCompatActivity implements OperationFragment.OnFragmentInteractionListener, ViewPager.OnPageChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_credit_payement);
    ...
    private void refresh(int position) {
        ...
        if (position==0){
            mtn = 0 ;
            try {
                operations = operationDAO.getAll(6,null, new Date());
                nbr = operations.size() ;
                for (int i = 0; i<nbr;++i){
    ...
    private void init() {
        preferences = PreferenceManager.getDefaultSharedPreferences(CreditPayementActivity.this) ;
    ...
    private void setupFragments() {
        ...
        if (this.operationFragment1 == null) {
            this.operationFragment1 = OperationFragment.newInstance(null,"6");
        }
        ...
        if (id == R.id.action_interval) {
            ...
            button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (dateBox != null) {
                        ...
                        if (mPosition==0) operationFragment1.interval(6,dateDebut,dateFin);
            ...
            impBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (imp){
                        try {
                            PrinterUtilsold printerUtils = new PrinterUtilsold(CreditPayementActivity.this,mService) ;
                        ...
                        try {
                            PrintPDA printPDA = new PrintPDA(CreditPayementActivity.this) ;
    ...
    private class  CollectionAdapter extends FragmentPagerAdapter {
        ...
        public CharSequence getPageTitle(int position) {
            switch (position){
                case 0 : {
                    return getString(R.string.acredit) ;
                }
                case 1 : {
