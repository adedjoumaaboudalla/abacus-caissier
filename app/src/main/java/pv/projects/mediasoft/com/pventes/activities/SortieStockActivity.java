...
public class SortieStockActivity extends AppCompatActivity implements VenteplusFormFragment.OnFragmentInteractionListener, View.OnClickListener, View.OnLongClickListener {
    public static final String SORTE_STOCK = "SortieStock";
    ...
    /*
        ...
        public void onFragmentInteraction(int checkedItems) {
            ...
            if(mMode != null) mMode.setTitle(String.valueOf(checkedItems) + getStrg(R.string.itemSelected));
        }
        ...
        public void changeContextual() {
            ...
            mMode = startSupportActionMode(new ActionMode.Callback() {
                ...
                public boolean onActionItemClicked(ActionMode mode, MenuItem item) {
                    ...
                    switch (item.getItemId()) {
                        case R.id.action_del:{
                            if (venteplusFormFragment != null){
                                venteplusFormFragment.deleteItem();
                            }
                            destroyActionMode();
                        }
                        break;
                ...
                public void onDestroyActionMode(ActionMode mode) {
                    mMode = null;
                    if (venteplusFormFragment != null) venteplusFormFragment.destroyActionMode();
                }
            });
        }
    ...
    */
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (event.getKeyCode() == KeyEvent.KEYCODE_BACK){
            ...
            builder.setTitle(getString(R.string.sortiestock)) ;
    ...
    */
        ...
        if (id == R.id.action_liste) {
            Intent intent = new Intent(SortieStockActivity.this,OperationActivity.class) ;
    ...
    private void setupFragments(Bundle bundle) {
        ...
        if(bundle == null) {
            ...
            if(intent != null) {
                venteplusFormFragment = VenteplusFormFragment.newInstance(type, null);
