...
public class PlacementFormActivity extends AppCompatActivity implements View.OnClickListener, View.OnLongClickListener {
    ...
    PlacementFormActivity.AddOperationTask addOperationTask = null ;
    ...
    private ArrayList<Partenaire> pa;
    ...
    private void initialisation() {
        ...
        clt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(PlacementFormActivity.this, PartenaireActivity.class) ;
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                if (position>0) {
                    if (!MODE.equals(ESPECE))description.setText(to.get(position-1).getLibelle() + " : " + cb.get(spinner_banque.getSelectedItemPosition()-1).getLibelle());
                    else description.setText(to.get(position-1).getLibelle() + " : " + getString(R.string.caisse));
                }
            }
        ...
        to = typeOperationDAO.getAllPlacement();
        ...
        mAdapter = new ArrayAdapter(PlacementFormActivity.this, android.R.layout.simple_list_item_1, typeoperations);
        ...
        venteBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                money_init() ;
                achat = false ;
                builder = new AlertDialog.Builder(PlacementFormActivity.this) ;
                builder.setView(rv) ;
                alert = builder.show() ;
            }
        });
        ...
        modegroupe.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, @IdRes int checkedId) {
                ...
                if (checkedId == R.id.espece) {
                    ...
                    CompteBanqueDAO compteBanqueDAO = new CompteBanqueDAO(PlacementFormActivity.this) ;
                    ...
                    mAdapter = new ArrayAdapter(PlacementFormActivity.this, android.R.layout.simple_list_item_1, banque);
    ...
    private void addOperation() {
        if (isValid()){
            ...
            addOperationTask = new AddOperationTask(description.getText().toString(),montant.getText().toString(),to.get(spinner.getSelectedItemPosition()-1),partenaire, cpt_bk) ;
    ...
    private boolean isValid() {
        ...
        if (spinner_banque.getSelectedItemPosition()==0 && spinner_banque.getVisibility()==View.VISIBLE && cb.size()>0) {
            Toast.makeText(PlacementFormActivity.this, getString(R.string.baquerror), Toast.LENGTH_LONG).show();
            return false;
        }
        ...
        if (MODE.equals(CHEQUE) && numerocheque.length()==0){
            Toast.makeText(PlacementFormActivity.this, getString(R.string.saisirnumcheque), Toast.LENGTH_LONG).show();
            return false;
        }
    ...
    public class AddOperationTask extends AsyncTask<Void, Integer, String> {
        ...
        public AddOperationTask(String desc, String mte, TypeOperation typeOperation, Partenaire partenaire,long cpt) {
        ...
        protected String doInBackground(Void... params) {
            ...
            operation.setPartenaire_id(pa.getId_externe());
        ...
        protected void onPostExecute(String result) {
            ...
            if (Long.valueOf(result)>0) {
                clean();
                Toast.makeText(PlacementFormActivity.this,getString(R.string.placement_success),Toast.LENGTH_LONG).show();
            }
            else
                Toast.makeText(PlacementFormActivity.this,getString(R.string.echec_ajout),Toast.LENGTH_LONG).show();
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            if (operationDAO==null)operationDAO = new OperationDAO(PlacementFormActivity.this) ;
            if (caisseDAO==null)caisseDAO = new CaisseDAO(PlacementFormActivity.this) ;
            if (typeOperationDAO==null)typeOperationDAO = new TypeOperationDAO(PlacementFormActivity.this) ;
        }
    }
