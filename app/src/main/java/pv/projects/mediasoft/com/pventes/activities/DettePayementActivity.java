...
public class DettePayementActivity extends AppCompatActivity implements OperationFragment.OnFragmentInteractionListener, ViewPager.OnPageChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_creance);
    ...
    private void refresh(int position) {
        ...
        if (position==0){
            mtn = 0 ;
            try {
                operations = operationDAO.getAll(16,null, new Date());
                nbr = operations.size() ;
                for (int i = 0; i<nbr;++i){
    ...
    private void init() {
        preferences = PreferenceManager.getDefaultSharedPreferences(DettePayementActivity.this) ;
    ...
    private void setupTablayout() {
        collectionAdapter = new DettePayementActivity.CollectionAdapter(getSupportFragmentManager());
    ...
    private void setupFragments() {
        ...
        if (this.operationFragment1 == null) {
            this.operationFragment1 = OperationFragment.newInstance(null,"16");
        }
        ...
        if (id == R.id.action_interval) {
            ...
            button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (dateBox != null) {
                        ...
                        if (mPosition==0) operationFragment1.interval(13,dateDebut,dateFin);
            ...
            impBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (imp){
                        try {
                            PrinterUtilsold printerUtils = new PrinterUtilsold(DettePayementActivity.this,mService) ;
                        ...
                        try {
                            PrintPDA printPDA = new PrintPDA(DettePayementActivity.this) ;
    ...
    private class  CollectionAdapter extends FragmentPagerAdapter {
        ...
        public CharSequence getPageTitle(int position) {
            switch (position){
                case 0 : {
                    return getString(R.string.dette) ;
                }
                case 1 : {
