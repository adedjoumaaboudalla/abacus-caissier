...
public class DeviceListActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.device_list);   //ÏÔÊ¾ÁÐ±í½çÃæ
    ...
    private AdapterView.OnItemClickListener mDeviceClickListener = new AdapterView.OnItemClickListener() {   //µã»÷ÁÐ±íÏî£¬Á¬½ÓÉè±¸
        public void onItemClick(AdapterView<?> av, View v, int arg2, long arg3) {
            ...
            Log.e("BlueTooth","Connect to " + address) ;
        ...
        public void handleMessage(Message message) {
            switch (message.what) {
                case BluetoothService.MESSAGE_STATE_CHANGE:
                    switch (message.arg1) {
                        case BluetoothService.STATE_CONNECTED:   //ÒÑÁ¬½Ó
                            Toast.makeText(DeviceListActivity.this, R.string.connexionreussi,Toast.LENGTH_SHORT).show();
                            break;
                ...
                case BluetoothService.MESSAGE_CONNECTION_LOST:    //À¶ÑÀÒÑ¶Ï¿ªÁ¬½Ó
                    Toast.makeText(DeviceListActivity.this, R.string.conneionperdubt,Toast.LENGTH_SHORT).show();
                    break;
                case BluetoothService.MESSAGE_UNABLE_CONNECT:     //ÎÞ·¨Á¬½ÓÉè±¸
                    Toast.makeText(DeviceListActivity.this, R.string.impossconnexbt,Toast.LENGTH_SHORT).show();
                    break;
            }
        }
